...
]{$if(beamer)$$documentclass$$else$$if(book)$scrbook$else$$if(report)$scrreprt$else$scrartcl$endif$$endif$$endif$}
$if(beamer)$
$if(background-image)$
...
$endif$
$if(headings-size)$
\KOMAoptions{headings=$headings-size$}
$endif$
$if(chapterprefix)$
...
$if(beamer)$
$else$
% \usepackage[font={stretch=1.2}, textfont={color=caption-color}, position=top, skip=4mm, labelfont=bf, singlelinecheck=false, labelsep=space, justification=$if(caption-justification)$$caption-justification$$else$raggedright$endif$]{caption}
\usepackage[font={stretch=1.2}, position=top, skip=4mm, labelfont=bf,
singlelinecheck=false, labelsep=space,
justification=$if(caption-justification)$$caption-justification$$else$raggedright$endif$]{caption}
...
\end{frame}
$else$
\printbibliography$if(biblio-title)$[title=$biblio-title$,heading=bibintoc]$else$[heading=bibintoc]$endif$
$endif$
